...
(function () {
    ...
    USE(function (module) {
        ...
        (function () {
            ...
            function perf(node, soul) { if (node !== this.graph[soul]) {
                return true;
            } } // HNPERF: do not port!
        ...
        function output(msg) {
            ...
            if (get = msg.get) {
                ...
                if (get['#'] || at.soul) {
                    ...
                    else if (obj_has(back.put, get)) { // TODO: support #LEX !
                        put = (back.$.get(get)._);
                        if (!(tmp = put.ack)) {
                            put.ack = -1;
                        }
    ...
    USE(function (module) {
        ...
        function soul(id, as, msg, eve) {
            var as = as.as, path = as.p, ref = as.ref, cat = as.at, pat = [], sat;
            as = as.as;
    ...
    USE(function (module) {
        ...
        Gun.chain.set = function (item, cb, opt) {
            ...
            item.get(function (soul, o, msg) {
                if (!soul && item._.stun) {
                    item._.on('res', function () { this.off(); gun.set(item, cb, opt); });
                    return;
                }
                if (!soul) {
        ...
        function Mesh(root) {
            ...
            (function () {
                ...
                var say = mesh.say = function (msg, peer) {
                    ...
                    if ((tmp = meta.to) && (tmp[peer.url] || tmp[peer.pid] || tmp[peer.id]) /*&& !o*/) {
                        return false;
                    }
                    if (peer.batch) {
    ...
    USE(function (module) {
        ...
        Gun.on('opt', function (root) {
            ...
            function reconnect(peer) {
                ...
                if ((doc && peer.retry <= 0) || peer.retired) {
                    return;
                }
                peer.retry = ((_a = peer.retry) !== null && _a !== void 0 ? _a : (opt.retry || 60)) - 1;
